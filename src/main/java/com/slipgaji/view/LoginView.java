...
public class LoginView extends JFrame {
    ...
    private static final Color ACCENT_BLUE    = new Color(96, 165, 250);   // Blue-400
...
=======
    ...
    private JLabel createFeatureLabel(String text) {
        ...
        label.setFont(new Font(Constants.FONT_FAMILY, Font.PLAIN, 14));
        label.setForeground(new Color(191, 219, 254)); // Blue-200
