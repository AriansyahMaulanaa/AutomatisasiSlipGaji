...
Alur Kerja Sistem
Manager melakukan login ke dalam sistem aplikasi.
Melakukan import berkas berekstensi Excel (.xlsx) yang memuat data presensi bulanan karyawan.
Sistem menghitung gaji kotor dan bersih tiap orang secara otomatis.
Sistem memproses slip digital dalam bentuk berkas PDF.
Manajer menekan tombol pengiriman, sehingga slip gaji diteruskan ke alamat email pribadi karyawan masing-masing.
Rekam arsip penggajian tersimpan dan dapat dilacak dengan indikator batch pengiriman.
